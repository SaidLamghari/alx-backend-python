...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org_name, mock_get_json):
        """
        Teste que la méthode org retourne les bonnes
        informations pour une organisation.

        Paramètres :
        - org_name : Nom de l'organisation à tester.
        - mock_get_json : Mock de la fonction get_json
        pour empêcher les appels HTTP réels.
        """
        ...
        # Vérification que le résultat
        # et l'appel au mock sont corrects
    ...
    def test_public_repos(self, mock_get_json):
        ...
        Paramètres :
        - mock_get_json : Mock de la fonction get_json
        pour retourner un payload de test.
        """
    ...
    def test_has_license(self, repo, license_key, expected):
        """
        Teste la méthode has_license pour
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """
    Tests d'intégration pour la classe
    GithubOrgClient avec des fixtures.
    ...
    def test_public_repos(self):
        ...
        Utilise les données simulées de
        org_payload et repos_payload pour les assertions.
        """
    ...
    def tearDownClass(cls):
        ...
        Cette méthode est appelée une fois après
